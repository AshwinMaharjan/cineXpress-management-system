...
if ($is_search) {
    $conditions = ["movies.title LIKE ?", "movies.movie_type = 'now_showing'"];
    $types      = 's';
    $params     = ["%{$movie_search}%"];
    ...
    $stmt = mysqli_prepare($con,
        "SELECT movies.*, category.catname
         FROM movies
         INNER JOIN category ON category.catid = movies.catid
         WHERE movies.movie_type = 'now_showing'
         ORDER BY movies.movieid DESC"
    );
}
...
<section class="hero">
    ...
    <div class="hero__inner">
        ...
        <div class="hero__stats">
            ...
            <!-- ★ NEW: Coming Soon stat -->
            <div class="hero__stat">
                <span class="hero__stat-value"><?= $coming_soon_count ?></span>
                <span class="hero__stat-label">Coming Soon</span>
            </div>

            <div class="hero__stat-divider" aria-hidden="true"></div>

            <div class="hero__stat">
                <span class="hero__stat-value"><?= count($categories) ?></span>

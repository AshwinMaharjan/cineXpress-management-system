        ...
        <div class="footer__inner">
            ...
            <div class="footer__col">
                ...
                <ul class="footer__links">
                    ...
                    <li>
                        <a href="movies.php" class="footer__link">
                            <i class="fa-solid fa-chevron-right"></i>
                            All Movies
                        </a>
                    </li>
                    <li>
                        <a href="theaters.php" class="footer__link">
                            <i class="fa-solid fa-chevron-right"></i>
                            Theaters
                        </a>
                    </li>
                    <li>
                        <a href="coming_soon.php" class="footer__link">
                            <i class="fa-solid fa-chevron-right"></i>
                            Coming Soon
                        </a>
                    </li>
            ...
            <div class="footer__col">
                ...
                <ul class="footer__links">
                    <li>
                        <a href="advertise_with_us.php" class="footer__link">
                            <i class="fa-solid fa-chevron-right"></i>
                            Advertise with Us
                        </a>
                    </li>
                    <li>
                        <a href="become_franchise.php" class="footer__link">
                            <i class="fa-solid fa-chevron-right"></i>
                            Become a Franchise
                        </a>
                    </li>
                    <li>
                        <a href="privacy_policy.php" class="footer__link">
                            <i class="fa-solid fa-chevron-right"></i>
                            Privacy Policy
                        </a>
                    </li>
